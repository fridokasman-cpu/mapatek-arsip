...
(function() {
    ...
    // 3. KOMPAS
    // ================================================================
    if (typeof L.control.compass === 'function') {
        L.control.compass({
            position: 'topleft',
            autoRotate: true,
            showCompass: true,
    ...
    function locateMe() {
        ...
        if (!status || !dot || !text || !accuracy) {
            console.warn('Elemen GPS tidak ditemukan');
            return;
        }
    ...
    function toggleTracking() {
        ...
        if (isTracking) {
            ...
            if (text) text.textContent = 'Rekam';
            stopTracking();
    ...
    function startTracking() {
        ...
        watchId = navigator.geolocation.watchPosition(
            function(position) {
                ...
                if (gpsText) gpsText.textContent = '📍 Tracking ' + trackPoints.length + ' titik';
                if (gpsAcc) gpsAcc.textContent = '±' + Math.round(acc) + 'm';
            },
            function(error) {
    ...
    function updateStats() {
        ...
        if (pointsEl) pointsEl.textContent = trackPoints.length;
    ...
    function clearTrack() {
        ...
        if (confirm('Hapus semua jejak yang terekam?')) {
            ...
            const gpsText = document.getElementById('gpsText');
            if (gpsText) gpsText.textContent = '📍 GPS Aktif';
    ...
    // ================================================================
    // 13. DRAW TOOLS (Gambar jalur manual)
    // ================================================================
    ...
    // ================================================================
    // 18. SERVICE WORKER (Offline) — opsional
    // ================================================================
    ...
    // ================================================================
    // 19. EKSPOR FUNGSI KE GLOBAL (agar bisa dipanggil dari HTML onclick)
    // ================================================================
    ...
    // ================================================================
    // 20. INIT (Panggil semua fungsi saat halaman dimuat)
    // ================================================================
