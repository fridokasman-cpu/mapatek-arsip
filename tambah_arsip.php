    ...
    <div class="upload-box">
        <form action="proses_upload.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <div class="form-text">
                    Format yang diperbolehkan: PDF, Word, Excel, ZIP, RAR, JPG, PNG<br>
                    Maksimal ukuran: 10 MB
                </div>
            </div>

            <div class="mb-3">
                <label class="form-label">Nama Pengupload</label>
                <input type="text" name="uploader" class="form-control" required 
                       placeholder="Nama Anda" value="<?= htmlspecialchars($_SESSION['username']); ?>">
            </div>
