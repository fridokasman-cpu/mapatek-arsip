...
<head>
    ...
    <style>
        ...
        .upload-box {
            ...
            box-shadow: 0 10px 30px rgba(0,0,0,0.1); max-width: 700px; margin: 0 auto;
        }
        .form-label { font-weight: 600; color: #1b4332; }
        .btn-upload {
            background: linear-gradient(135deg, #1b4332 0%, #2d6a4f 100%);
            color: white; padding: 0.8rem; border: none; border-radius: 10px;
            font-weight: 600; width: 100%; transition: 0.3s;
        }
        .btn-upload:hover { background: #2d6a4f; color: white; transform: translateY(-2px); }
    </style>
</head>
<body>
